...
export interface Config {
  ...
  AT_FIELD_PLACE_PHONE: string;
  AT_FIELD_PLACE_MAIL: string;
  AT_FIELD_PLACE_TO_UPDATE: string;
  AT_FIELD_PLACE_SOURCES: string;
  AT_FIELD_PLACE_WEBSITE: string;
  AT_FIELD_PLACE_ADDRESS: string;
