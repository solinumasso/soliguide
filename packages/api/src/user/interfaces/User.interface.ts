...
import type { AirtableSyncType } from "../../_models/airtable";
import { InvitationPopulate } from "./Invitation.interface";
import type { UserCampaignEmails } from "../types";
import { ModelWithId } from "../../_models/mongo";
import { OrganizationPopulate } from "../../_models/organization";
import { UserRight, UserRightOrganizationPopulate } from ".";
