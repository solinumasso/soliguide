...
const message =
  "Re-sync pro and admin-territory users to Brevo with updated fields (mobileNumber, landlineNumber, createdAt, lastLogin, invitationUrl)";
...
/** Re-syncs all pro and admin-territory users to Brevo via AMQP. */
export const up = async (db: Db) => {
  ...
  logger.info(
    `[MIGRATION] - Found ${totalCount} pro and admin-territory users to sync to Brevo`
  );
