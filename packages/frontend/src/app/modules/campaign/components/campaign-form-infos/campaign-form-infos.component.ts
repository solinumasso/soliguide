...
@Component({
  ...
  templateUrl: "./campaign-form-infos.component.html",
  styleUrls: ["./campaign-form-infos.component.css"],
})
export class CampaignFormInfosComponent
  extends ParentTempInfosFormComponent
  implements AfterViewInit
{
  public readonly specificServiceMessage =
    CAMPAIGN_LIST[CAMPAIGN_DEFAULT_NAME].specificServiceMessage;
  constructor(
  ...
  public ngAfterViewInit() {
    if (this.place.campaigns.runningCampaign.sections.tempMessage.date) {
      this.noChanges =
        !this.place.campaigns.runningCampaign.sections.tempMessage.changes;
    }
  }
}
