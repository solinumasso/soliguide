...
export const PLACE_PUBLICS_MOCK: PlacePublicsMock[] = [
  {
    expectedResults: {
      ...
      pt: "Boas-vindas exclusivas: adultos, pessoas isoladas, casais.",
  ...
  },
  {
    expectedResults: {
      ...
      pt: "Acolhimento incondicional adaptado a mulheres, refugiados, requerentes de asilo, pessoas isoladas, mulheres grávidas, estudantes, pessoas na prostituição.",
