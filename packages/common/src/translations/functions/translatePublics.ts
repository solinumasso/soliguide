...
export const translatePublics = (
  ...
  if (publics.age.min !== 0 || publics.age.max !== 99) {
    if (publics.age.min === 0 && publics.age.max === 18) {
      detailsText += i18next.t("PUBLICS_AGE_MINORS", { lng }) + "";
    } else if (publics.age.min === 18 && publics.age.max === 99) {
      detailsText += i18next.t("PUBLICS_AGE_MAJORS", { lng }) + "";
    } else if (publics.age.min !== 0 && publics.age.max === 99) {
      detailsText += i18next.t("PUBLICS_AGE_FROM_XX", {
        lng,
        replace: {
          min: publics.age.min,
        },
      ...
      detailsText += i18next.t("PUBLICS_AGE_TO_XX_MAX", {
        lng,
        replace: {
          max: publics.age.max,
        },
      ...
      detailsText += i18next.t("PUBLICS_SPECIFIC_AGE", {
        lng,
        replace: {
          age: publics.age.min,
        },
      ...
      detailsText += i18next.t("PUBLICS_AGE_RANGE", {
        lng,
        replace: {
          max: publics.age.max,
          min: publics.age.min,
...
export const translatePublicsDetails = (
  ...
  return translatePublics(i18next, lng, publics, stripTags, false);
};
