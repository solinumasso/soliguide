...
export const PLACE_LANGUAGES_LIST: Languages = {
  aa: {
...
export const PLACE_LANGUAGES_LIST_MAP_KEY: Array<string | null> =
  Object.keys(PLACE_LANGUAGES_LIST);

export const PLACE_LANGUAGES_LIST_MAP_KEY_FOR_LOGS: Array<string | null> =
  PLACE_LANGUAGES_LIST_MAP_KEY.concat(null);
