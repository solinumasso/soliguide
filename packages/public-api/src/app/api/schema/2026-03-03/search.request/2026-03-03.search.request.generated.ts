 ...
 */
import { Categories, GeoTypes, PLACE_LANGUAGES_LIST_MAP_KEY, PlaceType, PublicsAdministrative, PublicsFamily, PublicsGender, PublicsOther, SUPPORTED_LANGUAGES, UpdatedAtInterval, WelcomedPublics, WIDGETS_AVAILABLE } from '@soliguide/common';
import { z } from 'zod';
...
export const v20260101SearchRoutePayloadSchema = z
  .object({
    ...
    body: v20260303SearchRequestSchema,
  })
  .strict()
  .describe(
...
>;
export type v20260303SearchRequestSchemaType = z.infer<typeof v20260303SearchRequestSchema>;
