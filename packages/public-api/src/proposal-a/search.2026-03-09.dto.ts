...
export class TranslatedName20260309DTO {
  @ApiProperty({
...
export class Place20260309DTO {
  ...
  @ApiProperty({
    description: `Original and localized name of the place`,
  })
  name: TranslatedName20260309DTO;
...
export class SearchResponse20260309DTO {
  @ApiProperty({
