...
function mapValue(
  ...
  return Promise.resolve(mapper(value, container));
}
...
async function upgradeAddField(
  ...
  container[operation.field] = await operation.buildValue(container);
}
...
async function downgradeRemoveField(
  ...
  container[operation.field] = await operation.restoreValue(container);
}
...
async function upgradeMoveField(
  ...
  await upgradeRenameField(operation, container);
}
...
async function downgradeMoveField(
  ...
  await downgradeRenameField(operation, container);
}
...
async function downgradeSplitField(
  ...
  container[operation.from] = await operation.merge(values, container);
...
async function upgradeMergeFields(
  ...
  container[operation.to] = await operation.merge(values, container);
...
async function downgradeMergeFields(
  ...
  const splitResult = await operation.split(container[operation.to], container);
  ...
  return async (payload: unknown): Promise<unknown> => {
    return transformContainersAtPath(
      ...
      async (container) => {
        switch (operation.kind) {
          case 'addField':
            await upgradeAddField(operation, container);
            return;
          case 'removeField':
          ...
          case 'renameField':
            ...
            return;
          case 'copyField':
            await upgradeCopyField(operation, container);
            return;
          case 'moveField':
            await upgradeMoveField(operation, container);
            return;
          case 'replaceField':
            await upgradeReplaceField(operation, container);
            return;
          case 'splitField':
            await upgradeSplitField(operation, container);
            return;
          case 'mergeFields':
            await upgradeMergeFields(operation, container);
            return;
          case 'customTransform':
            await upgradeCustomTransform(operation, container);
            return;
        }
      },
    );
      ...
      async (container) => {
        switch (operation.kind) {
          case 'addField':
            ...
            return;
          case 'removeField':
            await downgradeRemoveField(operation, container);
            return;
          case 'renameField':
            await downgradeRenameField(operation, container);
            return;
          case 'copyField':
            ...
            return;
          case 'moveField':
            await downgradeMoveField(operation, container);
            return;
          case 'replaceField':
            await downgradeReplaceField(operation, container);
            return;
          case 'splitField':
            await downgradeSplitField(operation, container);
            return;
          case 'mergeFields':
            await downgradeMergeFields(operation, container);
            return;
          case 'customTransform':
            await downgradeCustomTransform(operation, container);
            return;
        }
      },
    );
